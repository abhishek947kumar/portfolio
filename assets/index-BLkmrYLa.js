...
• Drastically minimized state transition latency and eliminated traffic gridlock conditions.`},{keywords:["github","recent projects","last 6 months","6 months","latest","new projects"],answer:`Over the last 6 months (2026), Abhishek built and updated key repositories on GitHub (@abhishek947kumar):
...
• **Software & Web Engineering**: Django, REST APIs, Google Gemini AI, Git/GitHub, CI/CD, Agile/Jira`},{keywords:["why hire","hire","placement","value","strengths","fit","candidate"],answer:`Why Abhishek Kumar is a top candidate for engineering teams:
...
• **Placement Ready**: Immediately productive in Embedded Systems, Firmware, Hardware Design, or Software Engineering roles.`},{keywords:["contact","email","phone","reach","call","address","location","message"],answer:`Direct contact channels for Abhishek Kumar:
...
• Active participant and competitor in QUIZZOPHRENIA '25.`}]},F={inter:{id:"inter",name:"SF Pro / Inter",category:"macOS Native Sans",fontFamily:'"Inter", -apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif',sample:"Clean, elegant, authentic macOS default typography."},outfit:{id:"outfit",name:"Outfit",category:"Futuristic Geometric",fontFamily:'"Outfit", "Inter", sans-serif',sample:"Modern geometric curves tailored for sleek digital interfaces."},jakarta:{id:"jakarta",name:"Plus Jakarta Sans",category:"Modern Tech Sans",fontFamily:'"Plus Jakarta Sans", "Inter", sans-serif',sample:"Crisp contemporary sans-serif engineered for high readability."},jetbrains:{id:"jetbrains",name:"JetBrains Mono",category:"Developer Code Monospace",fontFamily:'"JetBrains Mono", "SF Mono", Menlo, monospace',sample:"True developer terminal aesthetics with high contrast glyphs."},playfair:{id:"playfair",name:"Playfair Display",category:"Executive Editorial Serif",fontFamily:'"Playfair Display", Georgia, "Times New Roman", serif',sample:"Refined editorial serif for prestigious executive portfolios."}};class _{constructor(){this.currentFontId=localStorage.getItem("abhishek_portfolio_font_id")||"inter",this.currentFontSize=parseInt(localStorage.getItem("abhishek_portfolio_font_size")||"100",10),this.currentLetterSpacing=localStorage.getItem("abhishek_portfolio_letter_spacing")||"normal",this.listeners=[],this.applyAll()}onChange(e){this.listeners.push(e)}notify(){this.listeners.forEach(e=>e({fontId:this.currentFontId,fontSize:this.currentFontSize,letterSpacing:this.currentLetterSpacing}))}setFontStyle(e){F[e]&&(this.currentFontId=e,localStorage.setItem("abhishek_portfolio_font_id",e),this.applyAll(),this.notify())}setFontSize(e){const t=Math.max(75,Math.min(140,e));this.currentFontSize=t,localStorage.setItem("abhishek_portfolio_font_size",t.toString()),this.applyAll(),this.notify()}increaseFontSize(e=5){this.setFontSize(this.currentFontSize+e)}decreaseFontSize(e=5){this.setFontSize(this.currentFontSize-e)}setLetterSpacing(e){this.currentLetterSpacing=e,localStorage.setItem("abhishek_portfolio_letter_spacing",e),this.applyAll(),this.notify()}resetDefaults(){this.setFontStyle("inter"),this.setFontSize(100),this.setLetterSpacing("normal")}applyAll(){const e=F[this.currentFontId]||F.inter,t=document.documentElement;t.style.setProperty("--font-system",e.fontFamily),t.style.setProperty("--base-font-size",`${13*(this.currentFontSize/100)}px`),t.style.fontSize=`${13*(this.currentFontSize/100)}px`,this.currentLetterSpacing==="tight"?t.style.setProperty("--letter-spacing-custom","-0.02em"):this.currentLetterSpacing==="wide"?t.style.setProperty("--letter-spacing-custom","0.04em"):t.style.setProperty("--letter-spacing-custom","normal")}}const A=new _;class K{constructor(e,t){this.wm=e,this.onWallpaperChange=t,this.isSpotlightOpen=!1,this.isControlCenterOpen=!1,this.isAppleMenuOpen=!1,this.isBatteryOpen=!1,this.isWifiOpen=!1}init(){this.startClock(),this.setupDropdowns(),this.setupPopovers(),this.setupQuickActions(),this.setupSpotlight(),this.setupControlCenter(),this.setupKeyboardShortcuts()}startClock(){const e=document.querySelector("#menu-clock"),t=()=>{if(!e)return;const s=new Date,i={weekday:"short",month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0};e.textContent=s.toLocaleDateString("en-US",i).replace(",","")};t(),setInterval(t,1e3)}setupDropdowns(){var s,i,n,a,o;const e=document.querySelector("#menu-apple-btn"),t=document.querySelector("#apple-dropdown-menu");e==null||e.addEventListener("click",r=>{r.stopPropagation(),this.closeAllMenus(),this.isAppleMenuOpen=!this.isAppleMenuOpen,t==null||t.classList.toggle("is-visible",this.isAppleMenuOpen)}),(s=document.querySelector("#menu-about-mac"))==null||s.addEventListener("click",()=>{this.wm.openWindow("settings"),this.closeAllMenus()}),(i=document.querySelector("#menu-sys-settings"))==null||i.addEventListener("click",()=>{this.wm.openWindow("settings"),this.closeAllMenus()}),(n=document.querySelector("#menu-app-store"))==null||n.addEventListener("click",()=>{this.wm.openWindow("projects"),this.closeAllMenus()}),(a=document.querySelector("#menu-sleep"))==null||a.addEventListener("click",()=>{this.triggerSleepOverlay(),this.closeAllMenus()}),(o=document.querySelector("#menu-restart"))==null||o.addEventListener("click",()=>{location.reload()}),document.addEventListener("click",r=>{var l;if(!r.target.closest("#apple-dropdown-menu")&&!r.target.closest("#menu-apple-btn")&&(t==null||t.classList.remove("is-visible"),this.isAppleMenuOpen=!1),!r.target.closest("#control-center-panel")&&!r.target.closest("#menu-control-center-btn")&&((l=document.querySelector("#control-center-panel"))==null||l.classList.remove("is-visible"),this.isControlCenterOpen=!1),!r.target.closest("#battery-popover")&&!r.target.closest("#menu-battery-btn")){const d=document.querySelector("#battery-popover");d&&(d.style.display="none"),this.isBatteryOpen=!1}if(!r.target.closest("#wifi-popover")&&!r.target.closest("#menu-wifi-btn")){const d=document.querySelector("#wifi-popover");d&&(d.style.display="none"),this.isWifiOpen=!1}})}setupQuickActions(){var e,t,s,i,n,a;(e=document.querySelector("#menu-active-app-name"))==null||e.addEventListener("click",()=>{this.wm.openWindow("settings")}),(t=document.querySelector("#menu-btn-quick-resume"))==null||t.addEventListener("click",()=>{this.wm.openWindow("resume")}),(s=document.querySelector("#menu-btn-quick-projects"))==null||s.addEventListener("click",()=>{this.wm.openWindow("projects")}),(i=document.querySelector("#menu-btn-quick-ai"))==null||i.addEventListener("click",()=>{this.wm.openWindow("siri")}),(n=document.querySelector("#menu-btn-quick-terminal"))==null||n.addEventListener("click",()=>{this.wm.openWindow("terminal")}),(a=document.querySelector("#menu-btn-quick-contact"))==null||a.addEventListener("click",()=>{this.wm.openWindow("mail")})}setupPopovers(){var n;const e=document.querySelector("#menu-battery-btn"),t=document.querySelector("#battery-popover");e==null||e.addEventListener("click",a=>{a.stopPropagation(),this.closeAllMenus(),this.isBatteryOpen=!this.isBatteryOpen,t&&(t.style.display=this.isBatteryOpen?"flex":"none")});const s=document.querySelector("#menu-wifi-btn"),i=document.querySelector("#wifi-popover");s==null||s.addEventListener("click",a=>{a.stopPropagation(),this.closeAllMenus(),this.isWifiOpen=!this.isWifiOpen,i&&(i.style.display=this.isWifiOpen?"flex":"none")}),(n=document.querySelector("#btn-open-network-settings"))==null||n.addEventListener("click",()=>{this.closeAllMenus(),this.wm.openWindow("social")})}setupControlCenter(){const e=document.querySelector("#menu-control-center-btn"),t=document.querySelector("#control-center-panel");e==null||e.addEventListener("click",a=>{a.stopPropagation(),this.closeAllMenus(),this.isControlCenterOpen=!this.isControlCenterOpen,t==null||t.classList.toggle("is-visible",this.isControlCenterOpen)});const s=document.querySelector("#cc-dark-mode-toggle");s==null||s.addEventListener("click",()=>{document.body.classList.toggle("light-mode"),s.classList.toggle("active")});const i=document.querySelector("#cc-focus-toggle");i==null||i.addEventListener("click",()=>{i.classList.toggle("active"),i.classList.contains("active")?(document.body.classList.add("placement-focus-mode"),this.showNotification("Placement Focus Active","Prioritizing candidate CGPA (8.73), VLSI & recent projects.")):document.body.classList.remove("placement-focus-mode")});const n=document.querySelector("#cc-brightness-slider");n==null||n.addEventListener("input",a=>{const o=a.target.value;document.documentElement.style.filter=`brightness(${o}%)`}),this.setupControlCenterTypography()}setupControlCenterTypography(){var r;const e=document.querySelector("#cc-font-size-slider"),t=document.querySelector("#cc-font-size-val"),s=document.querySelector("#btn-font-decrease"),i=document.querySelector("#btn-font-increase"),n=document.querySelector("#btn-font-reset"),a=document.querySelectorAll(".cc-font-pill"),o=l=>{t&&(t.textContent=`${l}%`),e&&(e.value=l)};o(A.currentFontSize),a.forEach(l=>{l.classList.toggle("active",l.getAttribute("data-font")===A.currentFontId),l.addEventListener("click",()=>{const d=l.getAttribute("data-font");A.setFontStyle(d),a.forEach(p=>p.classList.remove("active")),l.classList.add("active")})}),e==null||e.addEventListener("input",l=>{const d=parseInt(l.target.value,10);A.setFontSize(d),t&&(t.textContent=`${d}%`)}),s==null||s.addEventListener("click",()=>{A.decreaseFontSize(5),o(A.currentFontSize)}),i==null||i.addEventListener("click",()=>{A.increaseFontSize(5),o(A.currentFontSize)}),n==null||n.addEventListener("click",()=>{A.setFontSize(100),o(100)}),(r=document.querySelector("#ctx-change-typography"))==null||r.addEventListener("click",()=>{this.wm.openWindow("settings");const l=document.querySelector('.settings-nav-item[data-section="typography"]');l==null||l.click()})}setupSpotlight(){const e=document.querySelector("#menu-spotlight-btn"),t=document.querySelector("#spotlight-overlay"),s=document.querySelector("#spotlight-search-input"),i=document.querySelector("#spotlight-results-list"),n=()=>{this.isSpotlightOpen=!this.isSpotlightOpen,t.style.display=this.isSpotlightOpen?"flex":"none",this.isSpotlightOpen&&(s.value="",this.renderSpotlightResults("",i),setTimeout(()=>s.focus(),50))};e==null||e.addEventListener("click",a=>{a.stopPropagation(),n()}),t==null||t.addEventListener("click",a=>{a.target===t&&n()}),s==null||s.addEventListener("input",a=>{this.renderSpotlightResults(a.target.value,i)}),s==null||s.addEventListener("keydown",a=>{if(a.key==="Escape")n();else if(a.key==="Enter"){const o=i.querySelector(".spotlight-item");o&&o.click()}})}renderSpotlightResults(e,t){var o;const s=e.trim().toLowerCase(),i=[{type:"app",title:"Resume (Preview PDF)",sub:"View or download resume",id:"resume",icon:"📄"},{type:"app",title:"Projects (App Store)",sub:"7 engineering projects (last 6 months & hardware)",id:"projects",icon:"🛍️"},{type:"app",title:"Siri & Gemini AI Assistant",sub:"Ask questions about Abhishek with AI",id:"siri",icon:"🤖"},{type:"app",title:"Terminal (zsh)",sub:"Interactive command-line interface",id:"terminal",icon:"💻"},{type:"app",title:"Social & Activity Hub",sub:"Live GitHub commits & LinkedIn posts",id:"social",icon:"⚡"},{type:"app",title:"System Settings",sub:"Academic CGPA, hardware stack, wallpapers",id:"settings",icon:"⚙️"},{type:"app",title:"Safari Browser",sub:"Web demos & publications",id:"safari",icon:"🌐"},{type:"app",title:"Mail",sub:"Send placement interview invitation",id:"mail",icon:"✉️"},{type:"detail",title:"CGPA: 8.73 in B.Tech ECE",sub:"Institute of Engineering & Management, Kolkata",id:"resume",icon:"🎓"},{type:"detail",title:"VLSI Design Internship",sub:"Jadavpur University — IC design flow & EDA bare-metal",id:"settings",icon:"⚡"},{type:"detail",title:"Vocational Trainee",sub:"Steel Authority of India Limited (SAIL) — Plant automation",id:"settings",icon:"🏭"},{type:"detail",title:"IEEE IEMENTECH 2026 Publication",sub:"Piezoelectric energy harvesting wearable therapy (DOI)",id:"safari",icon:"📑"},{type:"detail",title:"Embedded Night-Vision System",sub:"Active IR + Thermal sensors with YOLOv2 (Sep 2026)",id:"projects",icon:"🌙"},{type:"detail",title:"Logistics Management System",sub:"Python & Django multi-dealer supply chain (Sep 2026)",id:"projects",icon:"📦"}],n=s?i.filter(r=>r.title.toLowerCase().includes(s)||r.sub.toLowerCase().includes(s)):i.slice(0,7);if(n.length===0){t.innerHTML=`
        <div class="spotlight-no-results">
          <p>No matches found for "<strong>${this.escape(s)}</strong>".</p>
          <button class="spotlight-ask-ai" id="btn-spotlight-ask-ai">
            <span>Ask Siri / Gemini AI instead &rarr;</span>
          </button>
        </div>
      `,(o=t.querySelector("#btn-spotlight-ask-ai"))==null||o.addEventListener("click",()=>{var l;document.querySelector("#spotlight-overlay").style.display="none",this.isSpotlightOpen=!1,this.wm.openWindow("siri");const r=document.querySelector("#ai-query-input");r&&(r.value=e,(l=document.querySelector("#ai-chat-form"))==null||l.dispatchEvent(new Event("submit")))});return}t.innerHTML=n.map(r=>`
    ...
    `).join(""),t.querySelectorAll(".spotlight-item").forEach(r=>{r.addEventListener("click",()=>{const l=r.getAttribute("data-app-id");document.querySelector("#spotlight-overlay").style.display="none",this.isSpotlightOpen=!1,this.wm.openWindow(l)})})}setupKeyboardShortcuts(){window.addEventListener("keydown",e=>{var t;(e.metaKey||e.ctrlKey)&&e.key.toLowerCase()==="k"&&(e.preventDefault(),(t=document.querySelector("#menu-spotlight-btn"))==null||t.click())})}closeAllMenus(){var s,i;(s=document.querySelector("#apple-dropdown-menu"))==null||s.classList.remove("is-visible"),(i=document.querySelector("#control-center-panel"))==null||i.classList.remove("is-visible");const e=document.querySelector("#battery-popover");e&&(e.style.display="none");const t=document.querySelector("#wifi-popover");t&&(t.style.display="none"),this.isAppleMenuOpen=!1,this.isControlCenterOpen=!1,this.isBatteryOpen=!1,this.isWifiOpen=!1}triggerSleepOverlay(){const e=document.querySelector("#lock-screen-overlay");e&&(e.style.display="flex",e.addEventListener("click",()=>{e.style.display="none"},{once:!0}))}showNotification(e,t){const s=document.querySelector("#notification-tray");if(!s)return;const i=document.createElement("div");i.className="macos-notification",i.innerHTML=`
    ...
    `,s.appendChild(i),setTimeout(()=>{i.classList.add("hide"),setTimeout(()=>i.remove(),400)},4e3)}escape(e){return e.replace(/[&<>'"]/g,"")}}class Y{constructor(e){this.wm=e,this.currentWallpaper="sequoia"}init(){this.setupDesktopIcons(),this.setupContextMenu(),this.setWallpaper(this.currentWallpaper)}setupDesktopIcons(){var t;const e=document.querySelectorAll(".desktop-icon");e.forEach(s=>{s.addEventListener("click",n=>{n.stopPropagation(),e.forEach(a=>a.classList.remove("is-selected")),s.classList.add("is-selected")}),s.addEventListener("dblclick",n=>{n.stopPropagation();const a=s.getAttribute("data-app");a&&this.wm.openWindow(a)});let i=0;s.addEventListener("touchend",n=>{const a=new Date().getTime(),o=a-i;if(o<500&&o>0){const r=s.getAttribute("data-app");r&&this.wm.openWindow(r),n.preventDefault()}i=a})}),(t=document.querySelector("#desktop"))==null||t.addEventListener("click",s=>{(s.target.id==="desktop"||s.target.classList.contains("desktop-wallpaper"))&&e.forEach(i=>i.classList.remove("is-selected"))})}setupContextMenu(){var s,i,n,a,o,r,l;const e=document.querySelector("#desktop-context-menu"),t=document.querySelector("#desktop");!e||!t||(t.addEventListener("contextmenu",d=>{if(d.target.closest(".macos-window")||d.target.closest("input")||d.target.closest("textarea"))return;d.preventDefault();const p=Math.min(window.innerWidth-220,d.clientX),u=Math.min(window.innerHeight-260,d.clientY);e.style.left=`${p}px`,e.style.top=`${u}px`,e.classList.add("is-visible")}),document.addEventListener("click",()=>{e.classList.remove("is-visible")}),(s=document.querySelector("#ctx-open-resume"))==null||s.addEventListener("click",()=>{this.wm.openWindow("resume")}),(i=document.querySelector("#ctx-open-projects"))==null||i.addEventListener("click",()=>{this.wm.openWindow("projects")}),(n=document.querySelector("#ctx-open-ai"))==null||n.addEventListener("click",()=>{this.wm.openWindow("siri")}),(a=document.querySelector("#ctx-open-terminal"))==null||a.addEventListener("click",()=>{this.wm.openWindow("terminal")}),(o=document.querySelector("#ctx-change-typography"))==null||o.addEventListener("click",()=>{this.wm.openWindow("settings"),setTimeout(()=>{const d=document.querySelector('.settings-nav-item[data-section="typography"]');d==null||d.click()},50)}),(r=document.querySelector("#ctx-change-wallpaper"))==null||r.addEventListener("click",()=>{this.wm.openWindow("settings"),setTimeout(()=>{const d=document.querySelector('.settings-nav-item[data-section="wallpaper"]');d==null||d.click()},50)}),(l=document.querySelector("#ctx-get-info"))==null||l.addEventListener("click",()=>{this.wm.openWindow("settings")}))}setWallpaper(e){this.currentWallpaper=e;const t=document.querySelector("#desktop-wallpaper");t&&(t.className="desktop-wallpaper wp-"+e,e==="sequoia"?(t.style.backgroundImage="url('/wallpapers/sequoia.jpg')",t.style.backgroundSize="cover",t.style.backgroundPosition="center"):e==="sonoma"?(t.style.backgroundImage="url('/wallpapers/sonoma.jpg')",t.style.backgroundSize="cover",t.style.backgroundPosition="center"):e==="cyberpunk"?t.style.backgroundImage="radial-gradient(circle at top right, #11e8bb 0%, #0d1117 70%)":e==="monterey"?t.style.backgroundImage="linear-gradient(135deg, #7928ca 0%, #ff0080 50%, #ff4d4d 100%)":e==="space"&&(t.style.backgroundImage="radial-gradient(ellipse at bottom, #1b2735 0%, #090a0f 100%)"))}}class J{constructor(e="ambient-3d-canvas"){this.canvas=document.getElementById(e),this.canvas&&(this.ctx=this.canvas.getContext("2d"),this.particles=[],this.numParticles=45,this.mouseX=0,this.mouseY=0,this.targetMouseX=0,this.targetMouseY=0,this.fov=300,this.isRunning=!0,this.init())}init(){this.resize(),window.addEventListener("resize",()=>this.resize()),window.addEventListener("mousemove",e=>{this.targetMouseX=(e.clientX-window.innerWidth/2)*.4,this.targetMouseY=(e.clientY-window.innerHeight/2)*.4});for(let e=0;e<this.numParticles;e++)this.particles.push({x:(Math.random()-.5)*window.innerWidth*1.5,y:(Math.random()-.5)*window.innerHeight*1.5,z:Math.random()*600-300,vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,vz:(Math.random()-.5)*.8,radius:Math.random()*2.5+1.2,hue:Math.random()>.5?210:280});this.animate()}resize(){this.canvas&&(this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight)}animate(){if(!this.isRunning||!this.ctx)return;this.mouseX+=(this.targetMouseX-this.mouseX)*.05,this.mouseY+=(this.targetMouseY-this.mouseY)*.05,this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);const e=this.canvas.width/2,t=this.canvas.height/2,s=[];for(let i of this.particles){i.x+=i.vx,i.y+=i.vy,i.z+=i.vz,i.x<-window.innerWidth&&(i.x=window.innerWidth),i.x>window.innerWidth&&(i.x=-window.innerWidth),i.y<-window.innerHeight&&(i.y=window.innerHeight),i.y>window.innerHeight&&(i.y=-window.innerHeight),i.z<-300&&(i.z=300),i.z>300&&(i.z=-300);const n=i.x-this.mouseX,a=i.y-this.mouseY,o=i.z+500,r=this.fov/o,l=e+n*r,d=t+a*r,p=Math.max(.08,Math.min(.65,(600-i.z)/600));s.push({x:l,y:d,scale:r,alpha:p,radius:i.radius*r,hue:i.hue})}this.ctx.lineWidth=.8;for(let i=0;i<s.length;i++)for(let n=i+1;n<s.length;n++){const a=s[i],o=s[n],r=a.x-o.x,l=a.y-o.y,d=Math.sqrt(r*r+l*l);if(d<130){const p=(1-d/130)*.18*Math.min(a.alpha,o.alpha);this.ctx.strokeStyle=`hsla(210, 85%, 65%, ${p})`,this.ctx.beginPath(),this.ctx.moveTo(a.x,a.y),this.ctx.lineTo(o.x,o.y),this.ctx.stroke()}}for(let i of s)this.ctx.fillStyle=`hsla(${i.hue}, 90%, 65%, ${i.alpha})`,this.ctx.shadowBlur=8,this.ctx.shadowColor=`hsla(${i.hue}, 90%, 65%, 0.6)`,this.ctx.beginPath(),this.ctx.arc(i.x,i.y,Math.max(.5,i.radius),0,Math.PI*2),this.ctx.fill(),this.ctx.shadowBlur=0;requestAnimationFrame(()=>this.animate())}}class ${static attach(e,t={}){const s=t.maxTilt||12,i=t.perspective||1e3,n=t.scale||1.03,a=t.glare!==!1;e.forEach(o=>{if(!o||o.dataset.tiltAttached)return;o.dataset.tiltAttached="true";let r=null;a&&!o.querySelector(".tilt-glare")?(r=document.createElement("div"),r.className="tilt-glare",o.style.position=o.style.position||"relative",o.style.overflow="hidden",o.appendChild(r)):r=o.querySelector(".tilt-glare"),o.style.transformStyle="preserve-3d",o.style.transition="transform 0.15s ease-out";let l=null;const d=()=>{l=o.getBoundingClientRect(),o.style.transition="none"},p=h=>{l||(l=o.getBoundingClientRect());const g=h.clientX-l.left,v=h.clientY-l.top,b=g/l.width*2-1,S=-(v/l.height*2-1)*s,I=b*s;if(o.style.transform=`perspective(${i}px) rotateX(${S.toFixed(2)}deg) rotateY(${I.toFixed(2)}deg) scale3d(${n}, ${n}, ${n})`,r){const L=(g/l.width*100).toFixed(1),D=(v/l.height*100).toFixed(1);r.style.opacity="1",r.style.background=`radial-gradient(circle at ${L}% ${D}%, rgba(255,255,255,0.25) 0%, transparent 65%)`}},u=()=>{o.style.transition="transform 0.5s cubic-bezier(0.2, 0.8, 0.2, 1)",o.style.transform=`perspective(${i}px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1)`,r&&(r.style.opacity="0"),l=null};o.addEventListener("mouseenter",d),o.addEventListener("mousemove",p),o.addEventListener("mouseleave",u)})}}class X{constructor(){this.customApiKey=typeof localStorage<"u"&&localStorage.getItem("abhishek_portfolio_gemini_key")||"",this.systemContext=this.buildSystemPrompt()}setApiKey(e){this.customApiKey=e.trim(),typeof localStorage<"u"&&(this.customApiKey?localStorage.setItem("abhishek_portfolio_gemini_key",this.customApiKey):localStorage.removeItem("abhishek_portfolio_gemini_key"))}hasCustomKey(){return!!this.customApiKey}buildSystemPrompt(){return`You are "Siri for Abhishek", an intelligent, articulate, and highly professional placement agent representing Abhishek Kumar, a B.Tech Electronics and Communication Engineering (ECE) student (Class of 2027) at Institute of Engineering & Management (IEM), Kolkata.
...
Profile Highlights:
- Name: Abhishek Kumar
- Email: ${c.personal.email} | Phone: ${c.personal.phone}
- LinkedIn: ${c.personal.linkedin} | GitHub: ${c.personal.github}
...
Always answer warmly, concisely, and with persuasive evidence of Abhishek's technical readiness for placements.`}async ask(e){const t=e.trim();if(!t)return"Please enter a question about Abhishek's skills, projects, or background.";if(this.customApiKey)try{const s=await this.callGeminiAPI(t);if(s)return s}catch(s){console.warn("Live Gemini API call failed, falling back to local semantic intelligence:",s)}return this.localSemanticSearch(t)}async query(e){return this.ask(e)}async callGeminiAPI(e){var n,a,o,r,l,d;const t=`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${this.customApiKey}`,s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{role:"user",parts:[{text:`${this.systemContext}

User Question: ${e}

Answer concisely in 2-4 sentences with markdown formatting:`}]}],generationConfig:{temperature:.2,maxOutputTokens:300}})});if(!s.ok){const p=await s.json().catch(()=>({}));throw new Error(((n=p.error)==null?void 0:n.message)||`HTTP ${s.status}`)}return(d=(l=(r=(o=(a=(await s.json()).candidates)==null?void 0:a[0])==null?void 0:o.content)==null?void 0:r.parts)==null?void 0:l[0])==null?void 0:d.text}localSemanticSearch(e){const t=e.toLowerCase();let s=null,i=0;for(const n of c.qaKnowledgeBase){let a=0;for(const o of n.keywords)t.includes(o)&&(a+=1);a>i&&(i=a,s=n.answer)}return i>=1?s:t.includes("who")||t.includes("abhishek")||t.includes("intro")||t.includes("about")?`**${c.personal.name}** is an Electronics & Communication Engineering undergraduate (Class of 2027) at **Institute of Engineering & Management (IEM), Kolkata** with a **8.73 CGPA**.

He specializes in **Embedded Systems, Hardware-Software Co-Design, and Software Engineering (Python/C++)**. He has published research with IEEE (IEMENTECH 2026) and completed industrial internships at **Jadavpur University** (VLSI Design) and **SAIL** (Plant Automation).`:t.includes("project")||t.includes("work")||t.includes("portfolio")||t.includes("build")?`Abhishek has engineered standout projects across hardware, AI, and software:
...
• **Frameworks & Cloud**: Django, REST APIs, UC San Diego IoT & AI Cloud certification`:t.includes("hire")||t.includes("placement")||t.includes("recruit")||t.includes("role")?`**Top Reasons to Hire Abhishek Kumar:**
...
4. **Industrial Proof**: Proven delivery in bare-metal EDA research at Jadavpur Univ and plant automation at SAIL.`:t.includes("contact")||t.includes("email")||t.includes("phone")||t.includes("linkedin")?`Get in touch with Abhishek:
...
Feel free to ask about his **CGPA**, **internships**, **projects from the last 6 months**, **IEEE paper**, or **why you should hire him**!`}}const H=new X;class Q{constructor(e){this.canvas=document.getElementById(e),this.canvas&&(this.ctx=this.canvas.getContext("2d"),this.scrollProgress=0,this.targetProgress=0,this.rotX=.3,this.rotY=0,this.rotZ=0,this.zoom=1,this.width=0,this.height=0,this.particles=[],this.numParticles=50,this.init())}init(){this.resize(),window.addEventListener("resize",()=>this.resize()),window.addEventListener("scroll",()=>this.onScroll(),{passive:!0});for(let e=0;e<this.numParticles;e++)this.particles.push({x:(Math.random()-.5)*600,y:(Math.random()-.5)*600,z:(Math.random()-.5)*600,speed:.2+Math.random()*.4,size:1+Math.random()*2,alpha:.2+Math.random()*.6});this.onScroll(),this.animate()}resize(){if(!this.canvas)return;const e=this.canvas.getBoundingClientRect(),t=Math.min(window.devicePixelRatio||1,2);this.width=e.width||window.innerWidth,this.height=e.height||600,this.canvas.width=this.width*t,this.canvas.height=this.height*t,this.ctx.scale(t,t)}onScroll(){const e=document.getElementById("cinematic-hero");if(!e){const n=document.documentElement.scrollHeight-window.innerHeight;this.targetProgress=n>0?window.scrollY/n:0;return}const t=e.getBoundingClientRect(),s=window.innerHeight*2,i=Math.max(0,Math.min(1,-t.top/s));this.targetProgress=i}animate(){this.scrollProgress+=(this.targetProgress-this.scrollProgress)*.08,this.rotY=this.scrollProgress*Math.PI*2.5+Date.now()*3e-4,this.rotX=.45+Math.sin(this.scrollProgress*Math.PI)*.35,this.rotZ=Math.sin(this.scrollProgress*Math.PI*2)*.2,this.zoom=1+this.scrollProgress*.6,this.render(),requestAnimationFrame(()=>this.animate())}project(e,t,s){let i=Math.cos(this.rotY),n=Math.sin(this.rotY),a=Math.cos(this.rotX),o=Math.sin(this.rotX),r=Math.cos(this.rotZ),l=Math.sin(this.rotZ),d=e*i+s*n,p=t,u=-e*n+s*i,h=d,g=p*a-u*o,v=p*o+u*a,b=h*r-g*l,k=h*l+g*r,S=v;const I=420*this.zoom,L=500+S,D=L>10?I/L:0;return{x:this.width/2+b*D,y:this.height/2+k*D,z:S,scale:D}}render(){const e=this.ctx;e.clearRect(0,0,this.width,this.height),this.particles.forEach(a=>{a.y-=a.speed,a.y<-300&&(a.y=300);const o=this.project(a.x,a.y,a.z);o.scale>0&&(e.beginPath(),e.arc(o.x,o.y,a.size*o.scale*.8,0,Math.PI*2),e.fillStyle=`rgba(100, 210, 255, ${a.alpha*.6})`,e.fill())});const t=130,s=12,i=this.scrollProgress*65;this.drawBox(0,20+i*.4,0,t+40,6,t+40,"#0a2318","#00ff88",.25),this.drawBox(0,8+i*.8,0,t+10,5,t+10,"#161922","#0070f3",.35),this.drawBox(0,-6-i*.2,0,t-20,s,t-20,"#1d2130","#64d2ff",.7),this.drawBox(0,-28-i*1.2,0,t-35,4,t-35,"#2e344a","#a855f7",.85);const n=18;for(let a=-t/2;a<=t/2;a+=n)this.drawPin(a,23+i*.4,-t/2-14),this.drawPin(a,23+i*.4,t/2+14),this.drawPin(-t/2-14,23+i*.4,a),this.drawPin(t/2+14,23+i*.4,a);this.drawCircuitTraces(i),this.drawHologramText(i)}drawBox(e,t,s,i,n,a,o,r,l){const d=this.ctx,p=i/2,u=n/2,h=a/2,g=[[-p,-u,-h],[p,-u,-h],[p,u,-h],[-p,u,-h],[-p,-u,h],[p,-u,h],[p,u,h],[-p,u,h]].map(([b,k,S])=>this.project(e+b,t+k,s+S));[{pts:[0,1,2,3],norm:[0,0,-1]},{pts:[5,4,7,6],norm:[0,0,1]},{pts:[4,0,3,7],norm:[-1,0,0]},{pts:[1,5,6,2],norm:[1,0,0]},{pts:[4,5,1,0],norm:[0,-1,0]},{pts:[3,2,6,7],norm:[0,1,0]}].forEach(b=>{d.beginPath();const k=g[b.pts[0]];d.moveTo(k.x,k.y);for(let S=1;S<b.pts.length;S++){const I=g[b.pts[S]];d.lineTo(I.x,I.y)}d.closePath(),d.fillStyle=o,d.globalAlpha=l,d.fill(),d.strokeStyle=r,d.lineWidth=1,d.stroke(),d.globalAlpha=1})}drawPin(e,t,s){const i=this.project(e,t,s),n=this.project(e,t+8,s);i.scale>0&&n.scale>0&&(this.ctx.beginPath(),this.ctx.moveTo(i.x,i.y),this.ctx.lineTo(n.x,n.y),this.ctx.strokeStyle="#ffd700",this.ctx.lineWidth=2*i.scale,this.ctx.stroke())}drawCircuitTraces(e){const t=this.ctx;[[[-40,-6,-40],[0,-6,-20],[30,-6,-35]],[[-30,-6,20],[-10,-6,0],[40,-6,25]],[[0,-6,-40],[15,-6,0],[-25,-6,35]]].forEach((i,n)=>{t.beginPath();const a=["#00f2fe","#38ef7d","#ff007f"];t.strokeStyle=a[n%a.length],t.lineWidth=1.8,i.forEach(([o,r,l],d)=>{const p=this.project(o,r-e*.2,l);d===0?t.moveTo(p.x,p.y):t.lineTo(p.x,p.y)}),t.stroke()})}drawHologramText(e){const t=this.project(0,-45-e*1.5,0);if(t.scale<=0)return;const s=this.ctx;s.save(),s.font=`700 ${Math.max(10,13*t.scale)}px -apple-system, sans-serif`,s.fillStyle="#64d2ff",s.textAlign="center",s.fillText("ABHISHEK-CORE • ECE 2027",t.x,t.y),s.font=`500 ${Math.max(8,10*t.scale)}px -apple-system, sans-serif`,s.fillStyle="rgba(255, 255, 255, 0.7)",s.fillText("8.73 CGPA • VLSI & BARE-METAL EDA",t.x,t.y+14*t.scale),s.restore()}}class Z{constructor(e){this.modeSwitcher=e,this.scrollyCanvas=null,this.activeFilter="all"}render(){return`
      ...
      <div class="cine-content-wrapper">
        ...
        <section class="cine-section" id="about">
          ...
          <div class="cine-about-grid">
            <div class="cine-profile-card">
              ...
              <h3 class="cine-profile-name">${c.personal.name}</h3>
              <div class="cine-profile-role">ECE Engineer • VLSI & Software</div>
              <p class="cine-profile-bio">
                ${c.personal.summary}
              </p>
              <div class="cine-social-links-row">
                <a href="${c.personal.linkedin}" target="_blank" class="cine-social-btn" title="LinkedIn">
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="${c.personal.github}" target="_blank" class="cine-social-btn" title="GitHub">
                ...
                <a href="mailto:${c.personal.email}" class="cine-social-btn" title="Email">
            ...
            <div class="cine-skills-box">
              ...
              <div class="cine-tags-cluster">
                ${c.skills.tools.map(e=>`<span class="cine-tech-pill">${e}</span>`).join("")}
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="cine-section" id="research">
          <div class="cine-publication-card">
            ...
            <h3 class="pub-title-big">"${c.publications[0].title}"</h3>
            <div class="pub-venue-line">${c.publications[0].venue}</div>
            <p class="pub-abstract-text">${c.publications[0].summary}</p>
            <div class="pub-actions-row">
              <a href="${c.publications[0].link}" target="_blank" class="btn-pub-doi">
                <span>View on IEEE Xplore Digital Library</span>
                <span>↗</span>
              </a>
              <span class="pub-author-tag">Authors: Abhishek Kumar et al. • DOI: ${c.publications[0].doi}</span>
            </div>
          </div>
        </section>
            ...
            <div class="cine-contact-info">
              ...
              <div class="contact-meta-row">
                ...
                <div>
                  ...
                  <strong>${c.personal.email}</strong>
                </div>
              </div>
              ...
              <div class="contact-meta-row">
                ...
                <div>
                  ...
                  <strong>${c.personal.phone}</strong>
                </div>
              </div>
              ...
              <div class="contact-meta-row">
                ...
                <div>
                  ...
                  <strong>${c.personal.location}</strong>
                </div>
              </div>

              <div style="margin-top: 24px; display: flex; gap: 10px; flex-wrap: wrap;">
                <a href="${c.personal.linkedin}" target="_blank" class="btn-cine-secondary" style="font-size: 13px;">
                  Connect on LinkedIn ↗
                </a>
                <a href="${c.personal.github}" target="_blank" class="btn-cine-secondary" style="font-size: 13px;">
                  Follow on GitHub ↗
                </a>
              </div>
            </div>
    ...
    `}renderProjectCards(e){let t=c.projects;return e==="recent"?t=t.filter(s=>s.createdPeriod==="Last 6 Months"||s.badge.includes("Recent")):e==="embedded"?t=t.filter(s=>s.tags.some(i=>["Embedded Systems","VLSI","IoT","Wokwi","Hardware"].includes(i))||s.title.toLowerCase().includes("embedded")||s.title.toLowerCase().includes("traffic")):e==="software"&&(t=t.filter(s=>s.tags.some(i=>["Python","Django","REST APIs","Enterprise Architecture","AI"].includes(i)))),t.map(s=>`
      <div class="cine-project-card ${s.createdPeriod==="Last 6 Months"?"is-hot":""}">
        <div class="cine-project-top">
          <span class="${s.createdPeriod==="Last 6 Months"?"cine-tag-hot":"cine-tag-normal"}">
            ${s.badge}
          </span>
          <span class="cine-project-period">${s.createdPeriod}</span>
        </div>

        <h3 class="cine-project-title">${s.title}</h3>
        <div class="cine-project-sub">${s.subtitle}</div>
        <p class="cine-project-desc">${s.description}</p>

        <div class="cine-project-techs">
          ${s.tags.map(i=>`<span class="tech-chip">${i}</span>`).join("")}
        </div>

        <div class="cine-project-actions">
          <a href="${s.githubUrl}" target="_blank" class="btn-card-inspect">
            Explore GitHub Repo ↗
          </a>
          <a href="${s.githubUrl}" target="_blank" class="btn-card-github" title="View Source">
            <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
          </a>
        </div>
      </div>
    `).join("")}initListeners(e){try{this.scrollyCanvas=new Q("scrolly-canvas")}catch(m){console.warn("ScrollyCanvas init note:",m)}$.attach(e.querySelectorAll(".cine-project-card"),{maxTilt:8,scale:1.02,glare:!0}),$.attach(e.querySelectorAll(".metric-stat-card"),{maxTilt:6,scale:1.03});const t=e.querySelector("#cine-nav-track"),s=e.querySelector("#cine-nav-slider"),i=e.querySelectorAll(".cine-nav-link"),n=m=>{if(!m||!s||!t)return;const f=t.getBoundingClientRect(),y=m.getBoundingClientRect();if(y.width===0||y.height===0)return;const E=y.left-f.left+(t.scrollLeft||0),x=y.top-f.top+(t.scrollTop||0);s.style.width=`${y.width}px`,s.style.height=`${y.height}px`,s.style.transform=`translate3d(${E}px, ${x}px, 0)`,s.style.opacity="1"},a=["hero","about","projects","experience","research","ai-assistant","contact"];let o=!1,r=null;const l=()=>{if(o)return;const m=Math.min(260,window.innerHeight*.35);let f=a[0];const y=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight,document.documentElement.offsetHeight,document.body.offsetHeight),E=window.scrollY||window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0;if((window.innerHeight||document.documentElement.clientHeight||800)+E>=y-80)f=a[a.length-1];else for(const B of a){const T=document.getElementById(B);T&&T.getBoundingClientRect().top<=m&&(f=B)}const P=e.querySelector(`.cine-nav-link[data-section="${f}"]`);P&&!P.classList.contains("active")&&(i.forEach(B=>B.classList.remove("active")),P.classList.add("active"),n(P));const z=e.querySelector(`.cine-mobile-nav-link[data-section="${f}"]`);z&&!z.classList.contains("active")&&(e.querySelectorAll(".cine-mobile-nav-link").forEach(B=>B.classList.remove("active")),z.classList.add("active"))};window.addEventListener("scroll",l,{passive:!0}),document.addEventListener("scroll",l,{passive:!0}),document.body.addEventListener("scroll",l,{passive:!0}),window.addEventListener("resize",()=>{const m=e.querySelector(".cine-nav-link.active")||i[0];n(m)}),window.addEventListener("hashchange",()=>{setTimeout(l,60)});const d=()=>{const m=window.location.hash?window.location.hash.replace("#",""):null;let f=m?e.querySelector(`.cine-nav-link[data-section="${m}"]`):null;f||(f=e.querySelector(".cine-nav-link.active")||i[0]),f&&(i.forEach(y=>y.classList.remove("active")),f.classList.add("active"),n(f))};d(),setTimeout(d,100),setTimeout(d,350),setTimeout(l,400),i.forEach(m=>{m.addEventListener("click",f=>{f.preventDefault();const y=m.getAttribute("href").replace("#",""),E=document.getElementById(y);E&&(o=!0,i.forEach(x=>x.classList.remove("active")),m.classList.add("active"),n(m),E.scrollIntoView({behavior:"smooth"}),history.pushState&&history.pushState(null,"",`#${y}`),clearTimeout(r),r=setTimeout(()=>{o=!1,l()},850))})}),e.querySelectorAll('a[href^="#"]').forEach(m=>{m.classList.contains("cine-nav-link")||m.classList.contains("cine-mobile-nav-link")||m.addEventListener("click",f=>{const y=m.getAttribute("href").replace("#",""),E=document.getElementById(y);if(E&&a.includes(y)){f.preventDefault(),o=!0;const x=e.querySelector(`.cine-nav-link[data-section="${y}"]`);x&&(i.forEach(P=>P.classList.remove("active")),x.classList.add("active"),n(x)),E.scrollIntoView({behavior:"smooth"}),history.pushState&&history.pushState(null,"",`#${y}`),clearTimeout(r),r=setTimeout(()=>{o=!1,l()},850)}})});const u=e.querySelector("#cine-mobile-toggle"),h=e.querySelector("#cine-mobile-drawer"),g=e.querySelectorAll(".cine-mobile-nav-link"),v=(m=!1)=>{!h||!u||(m||h.classList.contains("open")?(h.classList.remove("open"),u.classList.remove("open")):(h.classList.add("open"),u.classList.add("open")))};u==null||u.addEventListener("click",m=>{m.stopPropagation(),v()}),g.forEach(m=>{m.addEventListener("click",f=>{f.preventDefault();const y=m.getAttribute("href").replace("#",""),E=document.getElementById(y);if(v(!0),E){o=!0,g.forEach(P=>P.classList.remove("active")),m.classList.add("active");const x=e.querySelector(`.cine-nav-link[data-section="${y}"]`);x&&(i.forEach(P=>P.classList.remove("active")),x.classList.add("active"),n(x)),E.scrollIntoView({behavior:"smooth"}),history.pushState&&history.pushState(null,"",`#${y}`),clearTimeout(r),r=setTimeout(()=>{o=!1,l()},850)}})}),document.addEventListener("click",m=>{h!=null&&h.classList.contains("open")&&!h.contains(m.target)&&!(u!=null&&u.contains(m.target))&&v(!0)});const b=e.querySelector(".btn-mobile-hire");b==null||b.addEventListener("click",()=>{v(!0)});const k=e.querySelectorAll(".cine-filter-btn"),S=e.querySelector("#cine-projects-grid");k.forEach(m=>{m.addEventListener("click",()=>{k.forEach(y=>y.classList.remove("active")),m.classList.add("active");const f=m.getAttribute("data-filter");this.activeFilter=f,S.innerHTML=this.renderProjectCards(f),$.attach(S.querySelectorAll(".cine-project-card"),{maxTilt:8,scale:1.02,glare:!0})})});const I=e.querySelector("#cine-chat-log"),L=e.querySelector("#cine-ai-form"),D=e.querySelector("#cine-ai-input"),W=e.querySelectorAll(".ai-suggest-chip"),j=m=>{if(!m)return"";const y=m.replace(/([.!?:]?)\s+(?:and\s+)?([1-9]\d?[\.\)])\s+/g,`$1
• `).replace(/([.!?:]?)\s+(?:and\s+)?([•\-])\s+/g,`$1
• `).split(`
`),E=[];for(let x of y){let P=x.trim();if(!P)continue;const z=P.startsWith("•")||P.startsWith("-")||/^([1-9]\d?[\.\)]|[•\-\*])/.test(P);let T=P.replace(/^([•\-\*]|[1-9]\d?[\.\)])\s*/,"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");T=T.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),T=T.replace(/\*(.*?)\*/g,"<em>$1</em>"),T=T.replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" target="_blank" class="ai-chat-link">$1</a>'),z?E.push(`
            <div class="ai-bullet-item">
              <span class="ai-bullet-icon">🔹</span>
              <div class="ai-bullet-text">${T}</div>
            </div>
          `):E.push(`<div class="ai-para-item">${T}</div>`)}return E.join("")},G=async m=>{if(!m.trim())return;const f=document.createElement("div");f.className="cine-chat-msg user",f.textContent=`Q: ${m}`,I.appendChild(f);const y=document.createElement("div");y.className="cine-chat-msg assistant",y.innerHTML=`<span style="opacity: 0.7;">Thinking... searching Abhishek's verified credentials...</span>`,I.appendChild(y),I.scrollTop=I.scrollHeight;try{const E=await H.query(m);y.innerHTML=j(E)}catch(E){console.error("AI query error:",E),y.innerHTML="I am ready to assist! Please ask about Abhishek's <strong>CGPA (8.73)</strong>, <strong>VLSI internship</strong>, <strong>SAIL automation</strong>, <strong>IEEE publication</strong>, or <strong>projects in the last 6 months</strong>."}I.scrollTop=I.scrollHeight};L==null||L.addEventListener("submit",m=>{m.preventDefault();const f=D.value;D.value="",G(f)}),W.forEach(m=>{m.addEventListener("click",()=>{const f=m.getAttribute("data-q");G(f)})});const q=e.querySelector("#cine-contact-form"),M=e.querySelector("#cine-form-feedback");q==null||q.addEventListener("submit",m=>{m.preventDefault();const f=e.querySelector("#cine-name").value,y=e.querySelector("#cine-role").value,E=e.querySelector("#cine-msg").value;M&&(M.style.display="block",M.textContent=`✓ Thank you ${f}! Your interview invite regarding "${y}" has been recorded.`);const x=`mailto:abhishek1297kumar@gmail.com?subject=Placement Opportunity: ${encodeURIComponent(y)} from ${encodeURIComponent(f)}&body=${encodeURIComponent(E)}`;window.open(x,"_blank"),q.reset()})}}class ee{constructor(){this.currentMode="cinematic",this.cinematicContainer=null,this.desktopContainer=null,this.listeners=[]}init(e,t){this.cinematicContainer=e,this.desktopContainer=t,this.applyMode("cinematic")}onModeChange(e){this.listeners.push(e)}switchTo(e){this.applyMode("cinematic")}applyMode(e){this.cinematicContainer&&(this.cinematicContainer.style.display="block",this.desktopContainer&&(this.desktopContainer.style.display="none"),document.documentElement.style.height="auto",document.documentElement.style.overflowY="auto",document.documentElement.style.overflowX="hidden",document.body.style.height="auto",document.body.style.overflowY="auto",document.body.style.overflowX="hidden",document.title="Abhishek Kumar — Portfolio | B.Tech ECE (8.73 CGPA)")}}const R=new ee;class te{constructor(){this.currentPage=1,this.zoomLevel=100}render(){return`
            ...
            <div class="paper-3d-flipper" id="resume-flipper">
              ...
              <div class="paper-sheet paper-front" id="page-1">
                <header class="doc-header">
                  <h1 class="doc-name">${c.personal.name}</h1>
                  <p class="doc-address">${c.personal.address}</p>
                  <div class="doc-contact-row">
                    <a href="mailto:${c.personal.email}" class="doc-link">${c.personal.email}</a>
                    <span class="bullet">•</span>
                    <span>${c.personal.phone}</span>
                    <span class="bullet">•</span>
                    <a href="${c.personal.linkedin}" target="_blank" rel="noreferrer" class="doc-link">linkedin.com/in/abhishek947kumar</a>
                    <span class="bullet">•</span>
                    <a href="${c.personal.github}" target="_blank" rel="noreferrer" class="doc-link">github.com/abhishek947kumar</a>
                  </div>
                </header>
                ...
                <section class="doc-section">
                  ...
                  <p class="doc-text">${c.personal.summary}</p>
                </section>
              ...
              <div class="paper-sheet paper-back" id="page-2">
                <header class="doc-header mini">
                  <span class="doc-name-small">${c.personal.name} — Page 2</span>
                  <span class="doc-contact-small">${c.personal.email} | ${c.personal.phone}</span>
                </header>
    ...
    `}initListeners(e){const t=e.querySelector("#resume-prev-page"),s=e.querySelector("#resume-next-page"),i=e.querySelector("#resume-page-num"),n=e.querySelector("#resume-flipper"),a=b=>{this.currentPage=b,i.textContent=`Page ${b} of 2`,b===2?n==null||n.classList.add("is-flipped"):n==null||n.classList.remove("is-flipped")};t&&t.addEventListener("click",()=>a(1)),s&&s.addEventListener("click",()=>a(2));const o=e.querySelector("#resume-zoom-in"),r=e.querySelector("#resume-zoom-out"),l=e.querySelector("#resume-zoom-val"),d=e.querySelector("#paper-3d-scene"),p=b=>{this.zoomLevel=Math.max(70,Math.min(140,this.zoomLevel+b)),l.textContent=`${this.zoomLevel}%`,d.style.transform=`scale(${this.zoomLevel/100})`,d.style.transformOrigin="top center"};o&&o.addEventListener("click",()=>p(10)),r&&r.addEventListener("click",()=>p(-10));const u=e.querySelector("#btn-print-resume");u&&u.addEventListener("click",()=>{window.print()});const h=e.querySelector("#btn-copy-resume-text");h&&h.addEventListener("click",async()=>{const b=`ABHISHEK KUMAR
Sector-3, Bokaro Steel City, Jharkhand - 827003
${c.personal.email} | ${c.personal.phone}
...
SKILLS:
Embedded Systems, Microcontrollers, VLSI, C/C++, Python, MATLAB, Vivado, Wokwi, Git.`;try{await navigator.clipboard.writeText(b);const k=h.innerHTML;h.innerHTML="<span>Copied ATS Resume!</span>",setTimeout(()=>{h.innerHTML=k},2e3)}catch{alert("Resume ATS text copied!")}});const g=e.querySelector(".paper-front"),v=e.querySelector(".paper-back");g&&v&&$.attach([g,v],{maxTilt:6,scale:1.01,glare:!1})}}class se{constructor(){this.activeFilter="all",this.searchQuery="",this.selectedProject=null}render(){return`
    ...
    `}filterProjects(){return c.projects.filter(e=>{if(this.activeFilter==="recent"){if(e.createdPeriod!=="Last 6 Months")return!1}else if(this.activeFilter==="embedded"){if(!e.tags.some(s=>["Embedded Systems","Embedded C","Microcontrollers","Wokwi","Xilinx Vivado","Finite State Machines"].includes(s)))return!1}else if(this.activeFilter==="software"){if(!e.tags.some(s=>["Python","Django","React","GraphQL","Gemini AI API","TypeScript"].includes(s)))return!1}else if(this.activeFilter==="security"&&!e.tags.some(s=>["Cryptography","Security Algorithms","Pixel Manipulation","C++"].includes(s)))return!1;if(this.searchQuery){const t=this.searchQuery.toLowerCase(),s=e.title.toLowerCase().includes(t),i=e.description.toLowerCase().includes(t),n=e.tags.some(a=>a.toLowerCase().includes(t));return s||i||n}return!0})}renderProjectCards(){const e=this.filterProjects();return e.length===0?`
      ...
      `:e.map(t=>{const s=t.createdPeriod==="Last 6 Months";return`
        <div class="project-card 3d-tilt-card ${s?"is-recent":""}" data-project-id="${t.id}">
          <div class="card-header">
            <span class="card-badge ${s?"badge-hot":"badge-normal"}">${t.badge}</span>
          ...
          <div class="card-tags">
            ${t.tags.slice(0,4).map(i=>`<span class="tag-chip">${i}</span>`).join("")}
      ...
      `}).join("")}openDetailModal(e,t){const s=c.projects.find(r=>r.id===e);if(!s)return;const i=t.querySelector("#project-modal"),n=t.querySelector("#modal-content-body"),a=t.querySelector("#project-modal-dialog");n.innerHTML=`
      <div class="modal-proj-header">
        <span class="modal-badge">${s.badge}</span>
        <h3 class="modal-title">${s.title}</h3>
        <p class="modal-sub">${s.subtitle}</p>
      </div>

      <div class="modal-tech-row">
        ${s.tags.map(r=>`<span class="tech-badge">${r}</span>`).join("")}
      </div>
      ...
      <div class="modal-highlights-box">
        ...
        <ul>
          ${s.highlights.map(r=>`<li>${r}</li>`).join("")}
        </ul>
      </div>

      <div class="modal-actions-bar">
        <a href="${s.githubUrl}" target="_blank" rel="noreferrer" class="modal-primary-btn">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
    ...
    `,i.style.display="flex",a&&$.attach([a],{maxTilt:5,scale:1.01,glare:!1});const o=i.querySelector("#modal-btn-close-bottom");o&&(o.onclick=()=>{i.style.display="none"})}initListeners(e){const t=e.querySelectorAll(".sidebar-nav .nav-item"),s=e.querySelector("#projects-search-input"),i=e.querySelector("#projects-card-grid"),n=e.querySelector("#project-modal"),a=e.querySelector("#modal-close-btn"),o=e.querySelector("#appstore-hero-card");o&&$.attach([o],{maxTilt:6,scale:1.01});const r=()=>{i.innerHTML=this.renderProjectCards();const d=this.filterProjects().length,p=e.querySelector("#projects-count-label");p&&(p.textContent=`${d} Project${d===1?"":"s"}`),l()},l=()=>{e.querySelectorAll(".btn-inspect-proj").forEach(h=>{h.addEventListener("click",g=>{g.stopPropagation();const v=h.getAttribute("data-id");this.openDetailModal(v,e)})});const p=e.querySelectorAll(".project-card");p.forEach(h=>{h.addEventListener("click",()=>{const g=h.getAttribute("data-project-id");this.openDetailModal(g,e)})}),$.attach(p,{maxTilt:10,scale:1.025});const u=e.querySelector("#btn-reset-filter");u&&u.addEventListener("click",()=>{var h;this.activeFilter="all",this.searchQuery="",s&&(s.value=""),t.forEach(g=>g.classList.remove("active")),(h=e.querySelector('.nav-item[data-filter="all"]'))==null||h.classList.add("active"),r()})};t.forEach(d=>{d.addEventListener("click",()=>{t.forEach(p=>p.classList.remove("active")),d.classList.add("active"),this.activeFilter=d.getAttribute("data-filter"),r()})}),s&&s.addEventListener("input",d=>{this.searchQuery=d.target.value.trim(),r()}),a&&a.addEventListener("click",()=>{n.style.display="none"}),n&&n.addEventListener("click",d=>{d.target===n&&(n.style.display="none")}),l()}}class ie{constructor(){this.history=[{role:"assistant",text:`Hello! I am **Siri for Abhishek**, an AI assistant pre-trained on Abhishek Kumar's complete engineering resume, research publications, and GitHub activity.
...
Recruiters and visitors can search anything directly about his **8.73 CGPA**, **VLSI internship at Jadavpur**, **SAIL automation training**, **IEEE paper**, or **projects built in the last 6 months**! Try asking below or click a suggestion chip.`}],this.isThinking=!1}render(){return`
      <div class="ai-app-container">
        ...
        <div class="gemini-key-modal" id="gemini-key-modal" style="display: none;">
          <div class="gemini-modal-content">
            ...
            <input type="password" id="gemini-key-input" placeholder="AIzaSy..." value="${H.customApiKey}" />
    ...
    `}renderMessages(){return this.history.map((e,t)=>{const s=e.role==="user";return`
        <div class="chat-row ${s?"user-row":"assistant-row"}">
          <div class="chat-avatar">
            ${s?"👤":""}
          </div>
          <div class="chat-bubble">
            <div class="chat-text">${this.formatMarkdown(e.text)}</div>
            ${!s&&t===this.history.length-1?`
      ...
      `}).join("")}formatMarkdown(e){let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return t=t.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>"),t=t.replace(/^• (.*)$/gm,"<li>$1</li>"),t=t.replace(/^(<li>.*<\/li>)+$/gm,"<ul>$&</ul>"),t=t.replace(/\n\n/g,"<br><br>"),t=t.replace(/\n/g,"<br>"),t=t.replace(/\[(.*?)\]\((.*?)\)/g,'<a href="$2" target="_blank" rel="noreferrer" class="chat-link">$1</a>'),t}async handleQuery(e,t){if(!e||this.isThinking)return;this.history.push({role:"user",text:e}),this.isThinking=!0;const s=t.querySelector("#ai-chat-messages");s.innerHTML=this.renderMessages()+`
    ...
    `,s.scrollTop=s.scrollHeight;try{const i=await H.ask(e);this.history.push({role:"assistant",text:i})}catch{this.history.push({role:"assistant",text:"Abhishek Kumar is an ECE undergraduate at IEM Kolkata (8.73 CGPA) with VLSI and automation internships, IEEE publication, and strong hands-on embedded and software engineering skills."})}finally{this.isThinking=!1,s.innerHTML=this.renderMessages(),s.scrollTop=s.scrollHeight,this.attachMessageListeners(t)}}speakLastAnswer(){if(!("speechSynthesis"in window))return;const e=this.history[this.history.length-1];if(e&&e.role==="assistant"){window.speechSynthesis.cancel();const t=e.text.replace(/\*\*/g,"").replace(/•/g,"").replace(/\[(.*?)\]\(.*?\)/g,"$1"),s=new SpeechSynthesisUtterance(t);s.rate=1.05,s.pitch=1,window.speechSynthesis.speak(s)}}initListeners(e){const t=e.querySelector("#ai-chat-form"),s=e.querySelector("#ai-query-input"),i=e.querySelectorAll(".chip-btn"),n=e.querySelector("#btn-ai-voice"),a=e.querySelector("#btn-clear-ai-chat"),o=e.querySelector("#btn-ai-key-settings"),r=e.querySelector("#gemini-key-modal"),l=e.querySelector("#gemini-key-input"),d=e.querySelector("#btn-save-gemini-key"),p=e.querySelector("#btn-clear-gemini-key"),u=e.querySelector("#btn-close-gemini-modal"),h=e.querySelector("#ai-active-mode-badge"),g=()=>{H.hasCustomKey()?h&&(h.textContent="Live Gemini 1.5 Active",h.classList.add("badge-gemini-live")):h&&(h.textContent="Resume Intelligence Ready",h.classList.remove("badge-gemini-live"))};g(),t&&t.addEventListener("submit",v=>{v.preventDefault();const b=s.value.trim();b&&(s.value="",this.handleQuery(b,e))}),i.forEach(v=>{v.addEventListener("click",()=>{const b=v.getAttribute("data-query");b&&this.handleQuery(b,e)})}),n&&n.addEventListener("click",()=>this.speakLastAnswer()),a&&a.addEventListener("click",()=>{this.history=[{role:"assistant",text:"Chat reset! Ask me anything about Abhishek's projects, CGPA, research, or internships."}];const v=e.querySelector("#ai-chat-messages");v&&(v.innerHTML=this.renderMessages()),this.attachMessageListeners(e)}),o&&o.addEventListener("click",()=>{r.style.display="flex"}),u&&u.addEventListener("click",()=>{r.style.display="none"}),d&&d.addEventListener("click",()=>{const v=l.value.trim();H.setApiKey(v),g(),r.style.display="none"}),p&&p.addEventListener("click",()=>{H.setApiKey(""),l.value="",g(),r.style.display="none"}),this.attachMessageListeners(e)}attachMessageListeners(e){e.querySelectorAll(".copy-ans").forEach(s=>{s.addEventListener("click",async()=>{const i=decodeURIComponent(s.getAttribute("data-text"));await navigator.clipboard.writeText(i),s.classList.add("copied"),setTimeout(()=>s.classList.remove("copied"),1500)})})}}class ae{constructor(){this.currentUrl="https://github.com/abhishek947kumar",this.history=[this.currentUrl],this.historyIndex=0}render(){return`
          ...
          <div class="page-card linkedin-card">
            ...
            <div class="linkedin-profile-header">
              ...
              <div class="li-info">
                ...
                <span class="li-loc">${c.personal.location}</span>
                <div class="li-buttons">
                  <a href="${c.personal.linkedin}" target="_blank" class="li-btn-primary">Connect on LinkedIn</a>
                  <a href="mailto:${c.personal.email}" class="li-btn-secondary">Message / Email</a>
                </div>
              </div>
            </div>
            ...
            <div class="li-body-section">
              <h3>About</h3>
              <p>${c.personal.summary}</p>
            </div>

            <div class="li-body-section">
              <h3>Featured Publication</h3>
              <div class="li-pub-card">
                <h4>${c.publications[0].title}</h4>
                <p>${c.publications[0].venue} • Published 2026</p>
                <a href="${c.publications[0].link}" target="_blank" class="li-link">View in IEEE Xplore &rarr;</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="safari-web-page ieee-page">
          <div class="page-card ieee-card">
            ...
            <div class="ieee-abstract">
              <h4>Abstract:</h4>
              <p>${c.publications[0].summary}</p>
            </div>
            <div class="ieee-actions">
              <a href="${c.publications[0].link}" target="_blank" class="ieee-download-btn">Read on IEEE Xplore Official Portal</a>
            </div>
          </div>
        </div>
    ...
    `}navigateTo(e,t){this.currentUrl=e,this.history.push(e),this.historyIndex=this.history.length-1;const s=t.querySelector("#safari-address-input"),i=t.querySelector("#safari-external-link"),n=t.querySelector("#safari-viewport-content");s&&(s.value=e),i&&(i.href=e),n&&(n.innerHTML=this.renderPageContent(e))}initListeners(e){const t=e.querySelectorAll(".safari-bookmark"),s=e.querySelector("#safari-back"),i=e.querySelector("#safari-forward"),n=e.querySelector("#safari-refresh");t.forEach(a=>{a.addEventListener("click",()=>{const o=a.getAttribute("data-url");o&&this.navigateTo(o,e)})}),s&&s.addEventListener("click",()=>{if(this.historyIndex>0){this.historyIndex-=1;const a=this.history[this.historyIndex];this.navigateTo(a,e)}}),i&&i.addEventListener("click",()=>{if(this.historyIndex<this.history.length-1){this.historyIndex+=1;const a=this.history[this.historyIndex];this.navigateTo(a,e)}}),n&&n.addEventListener("click",()=>{const a=e.querySelector("#safari-viewport-content");a&&(a.style.opacity="0.5",setTimeout(()=>{a.innerHTML=this.renderPageContent(this.currentUrl),a.style.opacity="1"},300))})}}class ne{constructor(){this.history=[],this.historyIndex=-1}render(){return`
    ...
    `}executeCommand(e,t){const s=e.trim().toLowerCase(),i=s.split(" "),n=i[0],a=document.createElement("div");if(a.className="term-line term-cmd-echo",a.innerHTML=`<span class="prompt-user">abhishek@macbook-pro</span><span class="prompt-separator">:</span><span class="prompt-path">~</span><span class="prompt-symbol">%</span> ${this.escapeHTML(e)}`,t.appendChild(a),!s)return;let o="";switch(n){case"help":o=`
...
<div class="term-box">
  <span class="term-bold">${c.personal.name}</span> (${c.personal.tagline})<br>
  📍 ${c.personal.location}<br>
...
<div class="term-proj-item">
  <span class="term-cmd">${l+1}. ${r.title}</span> [${r.badge}]<br>
  &nbsp;&nbsp;Tech: ${r.tags.join(", ")}<br>
...
<div>
  ...
  ${r.points.map(l=>`• ${l}`).join("<br>")}<br>
  Skills: ${r.skillsUsed.join(", ")}
</div>
`).join("<br>")}`;break;case"publications":o=`
<div class="term-section-title">=== IEEE PUBLICATIONS ===</div>
<br>
<span class="term-bold">${c.publications[0].venue}</span><br>
Title: "${c.publications[0].title}"<br>
Status: ${c.publications[0].status}<br>
DOI: <a href="${c.publications[0].link}" target="_blank" class="term-link">${c.publications[0].doi}</a><br>
Summary: ${c.publications[0].summary}`;break;case"hire":o=`
<div class="term-section-title">=== WHY HIRE ABHISHEK KUMAR? ===</div>
<br>
${c.placementPitch.keyStrengths.map((r,l)=>`${l+1}. ${r}`).join("<br><br>")}
<br><br>
...
<div class="term-box">
  ...
  📧 Email: <a href="mailto:${c.personal.email}" class="term-link">${c.personal.email}</a><br>
  📞 Phone: ${c.personal.phone}<br>
  💼 LinkedIn: <a href="${c.personal.linkedin}" target="_blank" class="term-link">${c.personal.linkedin}</a><br>
  🐙 GitHub: <a href="${c.personal.github}" target="_blank" class="term-link">${c.personal.github}</a><br>
  📍 Address: ${c.personal.address}
</div>`;break;case"cat":i[1]==="resume"||i[1]==="resume.txt"||i[1]==="resume.pdf"?o=`
<div class="term-cat-resume">
============================================================<br>
ABHISHEK KUMAR<br>
${c.personal.address} | ${c.personal.phone}<br>
${c.personal.email} | ${c.personal.linkedin}<br>
============================================================<br>
ABOUT ME:<br>
${c.personal.summary}<br><br>
EDUCATION:<br>
...
</div>`:o=`cat: ${i[1]||"file"}: No such file or directory. Try 'cat resume'.`;break;case"clear":t.innerHTML="";return;case"neofetch":o=`
<pre class="neofetch-art">
   ...
   <span class="nf-apple">    .cooollllllccccllllllol.    </span>
</pre>`;break;default:o=`zsh: command not found: ${this.escapeHTML(n)}. Type '<span class="term-highlight">help</span>' for a list of commands.`;break}if(o){const r=document.createElement("div");r.className="term-line term-response",r.innerHTML=o,t.appendChild(r)}}escapeHTML(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]||t)}initListeners(e){const t=e.querySelector("#terminal-input"),s=e.querySelector("#terminal-output"),i=e.querySelector("#terminal-body");i.addEventListener("click",()=>{t.focus()}),t.addEventListener("keydown",n=>{if(n.key==="Enter"){const a=t.value;a.trim()&&(this.history.push(a),this.historyIndex=this.history.length),this.executeCommand(a,s),t.value="",i.scrollTop=i.scrollHeight}else n.key==="ArrowUp"?(n.preventDefault(),this.history.length>0&&this.historyIndex>0&&(this.historyIndex-=1,t.value=this.history[this.historyIndex]||"")):n.key==="ArrowDown"&&(n.preventDefault(),this.historyIndex<this.history.length-1?(this.historyIndex+=1,t.value=this.history[this.historyIndex]||""):(this.historyIndex=this.history.length,t.value=""))})}}const oe="abhishek947kumar",N="agy_portfolio_repos_cache",V="agy_portfolio_events_cache",re=10*60*1e3;class le{constructor(){this.username=oe,this.listeners=[]}onUpdate(e){this.listeners.push(e)}notifyListeners(e){this.listeners.forEach(t=>t(e))}async fetchUserData(){try{const e=await fetch(`https://api.github.com/users/${this.username}`);if(e.ok)return await e.json()}catch(e){console.warn("Could not fetch GitHub user profile:",e)}return{login:this.username,name:c.personal.name,avatar_url:"https://avatars.githubusercontent.com/u/153946376?v=4",html_url:`https://github.com/${this.username}`,public_repos:8,followers:1,following:3,bio:c.personal.tagline}}async fetchRepositories(e=!1){if(!e){const t=this.getCached(N);if(t)return t}try{const t=await fetch(`https://api.github.com/users/${this.username}/repos?sort=updated&per_page=100`);if(t.ok){const s=await t.json(),i=this.processRepos(s);return this.setCached(N,i),this.notifyListeners({type:"repos",data:i}),i}}catch(t){console.warn("Error fetching live GitHub repositories, using fallback:",t)}return this.getFallbackRepos()}async fetchEvents(e=!1){if(!e){const t=this.getCached(V);if(t)return t}try{const t=await fetch(`https://api.github.com/users/${this.username}/events?per_page=30`);if(t.ok){const s=await t.json(),i=this.processEvents(s);return this.setCached(V,i),this.notifyListeners({type:"events",data:i}),i}}catch(t){console.warn("Error fetching live GitHub events, using fallback:",t)}return this.getFallbackEvents()}processRepos(e){const t=new Date,s=new Date(t.getFullYear(),t.getMonth()-6,t.getDate());return e.map(i=>{const n=new Date(i.updated_at),a=n>=s;return{id:i.id,name:i.name,fullName:i.full_name,description:i.description||"No description provided.",url:i.html_url,language:i.language||"Code",stars:i.stargazers_count,forks:i.forks_count,openIssues:i.open_issues_count,updatedAt:i.updated_at,updatedFormatted:n.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),isLast6Months:a,topics:i.topics||[]}})}processEvents(e){return e.slice(0,15).map(t=>{var r,l,d,p,u,h,g,v;const i=new Date(t.created_at).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),n=t.repo?t.repo.name.replace(`${this.username}/`,""):"Repository";let a="Activity on repository",o="git-commit";if(t.type==="PushEvent"){const b=((l=(r=t.payload)==null?void 0:r.commits)==null?void 0:l.length)||1,k=((u=(p=(d=t.payload)==null?void 0:d.commits)==null?void 0:p[0])==null?void 0:u.message)||"Code update";a=`Pushed ${b} commit(s): "${k.length>50?k.substring(0,50)+"...":k}"`,o="git-push"}else t.type==="CreateEvent"?(a=`Created ${((h=t.payload)==null?void 0:h.ref_type)||"resource"} ${((g=t.payload)==null?void 0:g.ref)||n}`,o="plus-circle"):t.type==="WatchEvent"&&(a=`Starred repository ${n}`,o="star");return{id:t.id,type:t.type,repo:n,repoUrl:`https://github.com/${((v=t.repo)==null?void 0:v.name)||this.username}`,date:i,rawDate:t.created_at,description:a,icon:o}})}getCached(e){try{const t=localStorage.getItem(e);if(!t)return null;const s=JSON.parse(t);if(Date.now()-s.timestamp<re)return s.data}catch{}return null}setCached(e,t){try{localStorage.setItem(e,JSON.stringify({timestamp:Date.now(),data:t}))}catch{}}getFallbackRepos(){return[{id:1,name:"Embedded-Night-Vision-System",fullName:"abhishek947kumar/Embedded-Night-Vision-System",description:"Embedded Night-Vision System for Pedestrian Detection using Active IR and Thermal Sensors with HAAR+AdaBoost and YOLOv2",url:"https://github.com/abhishek947kumar/Embedded-Night-Vision-System",language:"Python",stars:1,forks:0,updatedFormatted:"Sep 19, 2026",isLast6Months:!0,topics:["embedded","night-vision","yolov2","infrared","deep-learning"]},{id:2,name:"Logistics-Management-System",fullName:"abhishek947kumar/Logistics-Management-System",description:"Enterprise-Grade Commercial Multi-Dealer & Consumer Logistics Management System in Python & Django.",url:"https://github.com/abhishek947kumar/Logistics-Management-System",language:"Python",stars:1,forks:0,updatedFormatted:"Sep 18, 2026",isLast6Months:!0,topics:["django","logistics","supply-chain","enterprise"]},{id:3,name:"YourFinance-Advanced-Expense-Tracker-with-Budget-Insights",fullName:"abhishek947kumar/YourFinance-Advanced-Expense-Tracker-with-Budget-Insights",description:"Modern financial control center with category budgets, savings milestones, and Google Gemini AI spending analytics.",url:"https://github.com/abhishek947kumar/YourFinance-Advanced-Expense-Tracker-with-Budget-Insights",language:"JavaScript",stars:1,forks:0,updatedFormatted:"Jul 19, 2026",isLast6Months:!0,topics:["finance","gemini-ai","budgeting","expense-tracker"]},{id:4,name:"Evershop",fullName:"abhishek947kumar/Evershop",description:"Modern, TypeScript-first eCommerce platform built with GraphQL and React with modular, customizable architecture.",url:"https://github.com/abhishek947kumar/Evershop",language:"TypeScript",stars:0,forks:0,updatedFormatted:"Aug 5, 2026",isLast6Months:!0,topics:["typescript","react","graphql","ecommerce"]},{id:5,name:"PRODIGY_CS_02",fullName:"abhishek947kumar/PRODIGY_CS_02",description:"Image encryption tool using pixel manipulation: pixel value swapping and mathematical reversible transformations.",url:"https://github.com/abhishek947kumar/PRODIGY_CS_02",language:"Python",stars:1,forks:0,updatedFormatted:"May 20, 2024",isLast6Months:!1,topics:["cryptography","image-encryption","security"]},{id:6,name:"PRODIGY_CS_01",fullName:"abhishek947kumar/PRODIGY_CS_01",description:"Caesar Cipher program to encrypt and decrypt messages by character shifts.",url:"https://github.com/abhishek947kumar/PRODIGY_CS_01",language:"Python",stars:1,forks:0,updatedFormatted:"May 12, 2025",isLast6Months:!1,topics:["cryptography","caesar-cipher"]}]}getFallbackEvents(){return[{id:"evt-1",type:"PushEvent",repo:"Embedded-Night-Vision-System",repoUrl:"https://github.com/abhishek947kumar/Embedded-Night-Vision-System",date:"Sep 19, 2026",description:"Pushed 2 commits: 'Optimized YOLOv2 inference pipeline on embedded edge unit'",icon:"git-push"},{id:"evt-2",type:"PushEvent",repo:"Logistics-Management-System",repoUrl:"https://github.com/abhishek947kumar/Logistics-Management-System",date:"Sep 18, 2026",description:"Pushed 3 commits: 'Enterprise dealer dispatch scheduling & consignment tracking'",icon:"git-push"},{id:"evt-3",type:"CreateEvent",repo:"Logistics-Management-System",repoUrl:"https://github.com/abhishek947kumar/Logistics-Management-System",date:"Sep 18, 2026",description:"Created branch 'main' with multi-dealer logistics architecture",icon:"plus-circle"},{id:"evt-4",type:"PushEvent",repo:"YourFinance-Advanced-Expense-Tracker-with-Budget-Insights",repoUrl:"https://github.com/abhishek947kumar/YourFinance-Advanced-Expense-Tracker-with-Budget-Insights",date:"Jul 19, 2026",description:"Pushed 4 commits: 'Integrated Google Gemini AI for smart wealth recommendations'",icon:"git-push"}]}}const O=new le;class ce{constructor(){this.activeTab="all",this.repos=[],this.events=[],this.customPosts=this.loadCustomPosts(),this.isRefreshing=!1}loadCustomPosts(){try{const e=localStorage.getItem("abhishek_portfolio_custom_posts");if(e)return JSON.parse(e)}catch{}return[]}saveCustomPosts(e){try{localStorage.setItem("abhishek_portfolio_custom_posts",JSON.stringify(e))}catch{}}render(){return`
          ...
          <div class="social-profile-summary">
            ...
            <div class="social-profile-text">
              <div class="profile-name-row">
                <h3>${c.personal.name}</h3>
                <span class="verified-pill">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
                  Verified Profile
                </span>
              </div>
              <p class="profile-bio">${c.personal.tagline}</p>
              <div class="social-links-row">
                <a href="${c.personal.github}" target="_blank" rel="noreferrer" class="social-tag github">
                ...
                <a href="${c.personal.linkedin}" target="_blank" rel="noreferrer" class="social-tag linkedin">
    ...
    `}async loadFeeds(e,t=!1){if(e.querySelector("#social-feed-content")){if(t){const i=e.querySelector("#btn-refresh-social");i==null||i.classList.add("is-refreshing")}try{const[i,n]=await Promise.all([O.fetchRepositories(t),O.fetchEvents(t)]);this.repos=i,this.events=n}catch(i){console.warn("Using fallback feeds:",i),this.repos=O.getFallbackRepos(),this.events=O.getFallbackEvents()}finally{const i=e.querySelector("#btn-refresh-social");i==null||i.classList.remove("is-refreshing"),this.renderFeedItems(e)}}}renderFeedItems(e){const t=e.querySelector("#social-feed-content");if(!t)return;const s=[];this.customPosts.forEach(a=>{s.push({type:"post",platform:a.platform,title:a.title,content:a.content,date:a.date,url:a.url||(a.platform==="LinkedIn"?c.personal.linkedin:c.personal.github),tags:a.tags,isCustom:!0})}),c.socialFeed.forEach(a=>{s.push({type:"post",platform:a.platform,title:a.title,content:a.content,date:a.date,url:a.url,tags:a.tags,isCustom:!1})}),this.events.forEach(a=>{s.push({type:"github-event",platform:"GitHub",title:`${a.repo}: ${a.description}`,content:`Direct repository update pushed to branch main. Repository: ${a.repo}`,date:a.date,url:a.repoUrl,tags:["#GitHubActivity","#LiveCommit"],isEvent:!0})});let i=s;this.activeTab==="github"?i=s.filter(a=>a.platform==="GitHub"):this.activeTab==="linkedin"&&(i=s.filter(a=>a.platform==="LinkedIn"));const n=this.repos.filter(a=>a.isLast6Months);t.innerHTML=`
    ...
    `}initListeners(e){const t=e.querySelectorAll(".soc-tab"),s=e.querySelector("#btn-refresh-social"),i=e.querySelector("#btn-open-post-modal"),n=e.querySelector("#broadcast-modal"),a=e.querySelector("#btn-close-broadcast"),o=e.querySelector("#btn-cancel-broadcast"),r=e.querySelector("#broadcast-post-form");t.forEach(d=>{d.addEventListener("click",()=>{t.forEach(p=>p.classList.remove("active")),d.classList.add("active"),this.activeTab=d.getAttribute("data-tab"),this.renderFeedItems(e)})}),s&&s.addEventListener("click",()=>{this.loadFeeds(e,!0)}),i&&i.addEventListener("click",()=>{n.style.display="flex"});const l=()=>{n.style.display="none"};a&&a.addEventListener("click",l),o&&o.addEventListener("click",l),r&&r.addEventListener("submit",d=>{d.preventDefault();const p=e.querySelector("#post-platform-select").value,u=e.querySelector("#post-title-input").value.trim(),h=e.querySelector("#post-content-input").value.trim(),g=e.querySelector("#post-tags-input").value.trim(),v=e.querySelector("#post-url-input").value.trim(),b=g?g.split(",").map(L=>L.trim().startsWith("#")?L.trim():`#${L.trim()}`):[],S=new Date().toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),I={id:"custom-"+Date.now(),platform:p,title:u,content:h,date:S,tags:b,url:v};this.customPosts.unshift(I),this.saveCustomPosts(this.customPosts),r.reset(),l(),this.renderFeedItems(e)}),this.loadFeeds(e)}}class de{constructor(e){this.activeSection="general",this.onWallpaperChange=e}render(){return`
        ...
        <aside class="settings-sidebar">
          <div class="settings-user-card">
            ...
            <div class="settings-user-meta">
              <span class="settings-name">${c.personal.name}</span>
    ...
    `}renderSection(e){switch(e){case"general":return`
          <div class="settings-section">
            ...
            <div class="mac-specs-card">
              ...
              <div class="mac-specs-list">
                ...
                <div class="spec-row">
                  ...
                  <span class="spec-v">${c.personal.name}</span>
                </div>
                <div class="spec-row">
                ...
                <div class="spec-row">
                  ...
                  <span class="spec-v">${c.personal.location}</span>
                </div>
                <div class="spec-row">
                  <span class="spec-k">Contact</span>
                  <span class="spec-v">${c.personal.email} | ${c.personal.phone}</span>
                </div>
              </div>
            </div>
            ...
            <div class="settings-subgroup">
              ...
              <p class="settings-desc">${c.personal.summary}</p>
        ...
        `;case"typography":const t=A.currentFontId,s=A.currentFontSize,i=A.currentLetterSpacing;return`
          <div class="settings-section">
            ...
            <div class="typo-control-card">
              <div class="typo-control-head">
                ...
                <span class="typo-scale-badge" id="settings-font-scale-badge">${s}%</span>
              </div>

              <div class="font-scale-slider-wrap">
                <span class="scale-label small">75% (Compact)</span>
                <input type="range" min="75" max="140" value="${s}" class="typo-range-input" id="settings-font-size-slider" />
                <span class="scale-label large">140% (Large)</span>
              </div>

              <div class="scale-presets-row">
                <button class="preset-pill ${s===85?"active":""}" data-size="85">Compact (85%)</button>
                <button class="preset-pill ${s===100?"active":""}" data-size="100">Default (100%)</button>
                <button class="preset-pill ${s===115?"active":""}" data-size="115">Enhanced (115%)</button>
                <button class="preset-pill ${s===130?"active":""}" data-size="130">High Legibility (130%)</button>
              </div>
            </div>
            ...
            <div class="typo-control-card spacing-card">
              ...
              <div class="spacing-buttons-row">
                <button class="spacing-btn ${i==="tight"?"active":""}" data-spacing="tight">Tight (-0.02em)</button>
                <button class="spacing-btn ${i==="normal"?"active":""}" data-spacing="normal">Normal (Default)</button>
                <button class="spacing-btn ${i==="wide"?"active":""}" data-spacing="wide">Wide (+0.04em)</button>
              </div>
            </div>
        ...
        `;case"credentials":return`
          <div class="settings-section">
            ...
            <div class="credential-box">
              ...
              <p class="pub-title">"${c.publications[0].title}"</p>
              <p class="pub-venue">${c.publications[0].venue}</p>
              <p class="pub-doi">DOI: <a href="${c.publications[0].link}" target="_blank">${c.publications[0].doi}</a></p>
              <p class="pub-sum">${c.publications[0].summary}</p>
            </div>

            <div class="credential-box">
              <h4>Professional Memberships</h4>
              <ul class="cert-list">
                ${c.activities[0].items.map(n=>`<li>${n}</li>`).join("")}
              </ul>
            </div>
            ...
            <div class="credential-box">
              ...
              <ul class="cert-list">
                ${c.certifications.map(n=>`<li><strong>${n.title}</strong> — ${n.issuer}</li>`).join("")}
              </ul>
            </div>
          </div>
        `;default:return""}}initListeners(e){const t=e.querySelectorAll(".settings-nav-item"),s=e.querySelector("#settings-main-pane");t.forEach(i=>{i.addEventListener("click",()=>{t.forEach(n=>n.classList.remove("active")),i.classList.add("active"),this.activeSection=i.getAttribute("data-section"),s.innerHTML=this.renderSection(this.activeSection),this.attachSectionListeners(s)})}),this.attachSectionListeners(s)}attachSectionListeners(e){const t=e.querySelectorAll(".wp-card");t.forEach(l=>{l.addEventListener("click",()=>{const d=l.getAttribute("data-wallpaper");this.onWallpaperChange&&this.onWallpaperChange(d),t.forEach(p=>p.classList.remove("selected")),l.classList.add("selected")})});const s=e.querySelectorAll(".font-family-card");s.forEach(l=>{l.addEventListener("click",()=>{const d=l.getAttribute("data-font-id");A.setFontStyle(d),s.forEach(h=>{h.classList.remove("selected");const g=h.querySelector(".font-active-status");g&&(g.textContent="Click to Apply")}),l.classList.add("selected");const p=l.querySelector(".font-active-status");p&&(p.textContent="✓ Active Typography"),document.querySelectorAll(".cc-font-pill").forEach(h=>{h.getAttribute("data-font")===d?h.classList.add("active"):h.classList.remove("active")})})});const i=e.querySelector("#settings-font-size-slider"),n=e.querySelector("#settings-font-scale-badge");i&&i.addEventListener("input",l=>{const d=parseInt(l.target.value,10);A.setFontSize(d),n&&(n.textContent=`${d}%`),e.querySelectorAll(".preset-pill").forEach(g=>{g.classList.toggle("active",parseInt(g.getAttribute("data-size"),10)===d)});const u=document.querySelector("#cc-font-size-val"),h=document.querySelector("#cc-font-size-slider");u&&(u.textContent=`${d}%`),h&&(h.value=d)});const a=e.querySelectorAll(".preset-pill");a.forEach(l=>{l.addEventListener("click",()=>{const d=parseInt(l.getAttribute("data-size"),10);A.setFontSize(d),i&&(i.value=d),n&&(n.textContent=`${d}%`),a.forEach(h=>h.classList.remove("active")),l.classList.add("active");const p=document.querySelector("#cc-font-size-val"),u=document.querySelector("#cc-font-size-slider");p&&(p.textContent=`${d}%`),u&&(u.value=d)})});const o=e.querySelectorAll(".spacing-btn");o.forEach(l=>{l.addEventListener("click",()=>{const d=l.getAttribute("data-spacing");A.setLetterSpacing(d),o.forEach(p=>p.classList.remove("active")),l.classList.add("active")})});const r=e.querySelector("#btn-reset-typography");r&&r.addEventListener("click",()=>{A.resetDefaults(),e.innerHTML=this.renderSection("typography"),this.attachSectionListeners(e)}),$.attach(e.querySelectorAll(".font-family-card"),{maxTilt:8,scale:1.02})}}class pe{render(){return`
      <div class="mail-app-container">
        ...
        <aside class="mail-sidebar">
          ...
          <div class="mail-contact-card">
            ...
            <p><strong>Email:</strong> ${c.personal.email}</p>
            <p><strong>Phone:</strong> ${c.personal.phone}</p>
            <p><strong>Address:</strong> ${c.personal.address}</p>
        ...
        <main class="mail-main">
          ...
          <form class="mail-form" id="placement-mail-form">
            <div class="mail-field-row">
              <label>To:</label>
              <input type="text" value="Abhishek Kumar <${c.personal.email}>" readonly class="mail-input-readonly" />
            </div>
            <div class="mail-field-row">
              <label>From:</label>
    ...
    `}initListeners(e){const t=e.querySelector("#placement-mail-form"),s=e.querySelector("#mail-company"),i=e.querySelector("#mail-subject"),n=e.querySelector("#mail-body"),a=e.querySelectorAll(".template-chip"),o=e.querySelector("#btn-copy-contact-all"),r=e.querySelector("#mail-sent-feedback");a.forEach(l=>{l.addEventListener("click",()=>{const d=l.getAttribute("data-template");d==="interview"?(i.value="Technical Interview Invitation - Campus Placements | Abhishek Kumar",n.value=`Hi Abhishek,
...
Best regards,
Recruitment Team`):d==="embedded"?(i.value="Job Opportunity: Embedded Firmware / Systems Engineer - Abhishek Kumar",n.value=`Hi Abhishek,
...
Warm regards,
Talent Acquisition`):d==="software"&&(i.value="SDE Opportunity: Software Engineering Team - Abhishek Kumar",n.value=`Hi Abhishek,
...
Best regards,
Engineering Hiring`)})}),t&&t.addEventListener("submit",l=>{l.preventDefault();const d=encodeURIComponent(i.value),p=encodeURIComponent(n.value+`

Company: `+s.value),u=`mailto:${c.personal.email}?subject=${d}&body=${p}`;r.style.display="inline-block",setTimeout(()=>{window.location.href=u},300)}),o&&o.addEventListener("click",async()=>{const l=`Abhishek Kumar
Email: ${c.personal.email}
Phone: ${c.personal.phone}
LinkedIn: ${c.personal.linkedin}
GitHub: ${c.personal.github}`;await navigator.clipboard.writeText(l),o.textContent="Copied to Clipboard!",setTimeout(()=>{o.textContent="Copy Contact Info"},2e3)})}}document.addEventListener("DOMContentLoaded",()=>{const w=document.querySelector("#cinematic-portfolio"),e=document.querySelector("#desktop");if(w){const M=new Z(R);w.innerHTML=M.render(),M.initListeners(w)}try{new J("ambient-3d-canvas")}catch(M){console.warn("3D Ambient Canvas initialization notice:",M)}const t=document.querySelector("#menu-active-app-name");C.init(t);const s=new Y(C);s.init();const i=new K(C,M=>s.setWallpaper(M));i.init();const n=new te,a=document.querySelector("#content-resume");a&&(a.innerHTML=n.render(),n.initListeners(a));const o=new se,r=document.querySelector("#content-projects");r&&(r.innerHTML=o.render(),o.initListeners(r));const l=new ie,d=document.querySelector("#content-siri");d&&(d.innerHTML=l.render(),l.initListeners(d));const p=new ae,u=document.querySelector("#content-safari");u&&(u.innerHTML=p.render(),p.initListeners(u));const h=new ne,g=document.querySelector("#content-terminal");g&&(g.innerHTML=h.render(),h.initListeners(g));const v=new ce,b=document.querySelector("#content-social");b&&(b.innerHTML=v.render(),v.initListeners(b));const k=new de(M=>s.setWallpaper(M)),S=document.querySelector("#content-settings");S&&(S.innerHTML=k.render(),k.initListeners(S));const I=new pe,L=document.querySelector("#content-mail");L&&(L.innerHTML=I.render(),I.initListeners(L)),C.registerWindow("resume",{title:"Preview",icon:"📄",el:document.querySelector("#win-resume"),defaultWidth:780,defaultHeight:560,x:40,y:50}),C.registerWindow("projects",{title:"Project Store",icon:"🛍️",el:document.querySelector("#win-projects"),defaultWidth:840,defaultHeight:580,x:100,y:60}),C.registerWindow("siri",{title:"Siri & Gemini AI",icon:"🤖",el:document.querySelector("#win-siri"),defaultWidth:640,defaultHeight:540,x:180,y:70}),C.registerWindow("safari",{title:"Safari",icon:"🌐",el:document.querySelector("#win-safari"),defaultWidth:800,defaultHeight:560,x:140,y:60}),C.registerWindow("terminal",{title:"Terminal",icon:"💻",el:document.querySelector("#win-terminal"),defaultWidth:700,defaultHeight:460,x:120,y:90}),C.registerWindow("social",{title:"Activity Hub",icon:"⚡",el:document.querySelector("#win-social"),defaultWidth:800,defaultHeight:560,x:80,y:65}),C.registerWindow("settings",{title:"System Settings",icon:"⚙️",el:document.querySelector("#win-settings"),defaultWidth:760,defaultHeight:520,x:160,y:75}),C.registerWindow("mail",{title:"Mail",icon:"✉️",el:document.querySelector("#win-mail"),defaultWidth:680,defaultHeight:500,x:150,y:80});const D=document.querySelectorAll(".desktop-icon");$.attach(D,{maxTilt:16,scale:1.05,glare:!1});const W=document.querySelectorAll(".dock-item");$.attach(W,{maxTilt:18,scale:1.15,glare:!1});const j=document.querySelectorAll(".stat-box");$.attach(j,{maxTilt:10,scale:1.04,glare:!0}),document.querySelectorAll(".dock-item[data-app]").forEach(M=>{M.addEventListener("click",()=>{const m=M.getAttribute("data-app");m==="finder"?C.openWindow("resume"):m&&C.toggleWindowFromDock(m)})});const q=document.querySelector("#dock-trash");q==null||q.addEventListener("click",()=>{i.showNotification("Trash is Clean","All compiler warnings and bugs were resolved in pre-commit hooks! 🧹")}),R.init(w,e),R.onModeChange(M=>{M==="desktop"&&(C.openWindow("resume"),setTimeout(()=>{C.openWindow("siri")},200))}),R.currentMode==="desktop"&&setTimeout(()=>{C.openWindow("resume"),setTimeout(()=>{C.openWindow("siri")},200)},100)});
