...
5. **Industrial Proof**: Proven delivery in bare-metal EDA research at Jadavpur Univ and plant automation at SAIL.`:t.includes("contact")||t.includes("email")||t.includes("phone")||t.includes("linkedin")?`Get in touch with Abhishek:
            ...
            <div class="paper-3d-flipper" id="resume-flipper">
              ...
              <div class="paper-sheet paper-back" id="page-2">
                <header class="doc-header mini">
                  ...
                  <span class="doc-contact-small">${l.personal.email} | ${l.personal.phone}</span>
                </header>
