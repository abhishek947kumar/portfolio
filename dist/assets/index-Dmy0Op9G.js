...
Answer concisely in 2-4 sentences with markdown formatting:`}]}],generationConfig:{temperature:.2,maxOutputTokens:300}})});if(!s.ok){const p=await s.json().catch(()=>({}));throw new Error(((n=p.error)==null?void 0:n.message)||`HTTP ${s.status}`)}return(d=(l=(r=(o=(a=(await s.json()).candidates)==null?void 0:a[0])==null?void 0:o.content)==null?void 0:r.parts)==null?void 0:l[0])==null?void 0:d.text}localSemanticSearch(e){const t=e.toLowerCase();let s=null,i=0;for(const n of c.qaKnowledgeBase){let a=0;for(const o of n.keywords)t.includes(o)&&(a+=1);a>i&&(i=a,s=n.answer)}return i>=1?s:t.includes("who")||t.includes("abhishek")||t.includes("intro")||t.includes("about")?`**${c.personal.name}** is a **B.Tech ECE 4th year candidate** (Class of 2027) at **Institute of Engineering & Management (IEM), Kolkata** with an **8.73 CGPA**.
